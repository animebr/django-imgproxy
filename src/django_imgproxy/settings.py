...
IMGPROXY_BASE64_FILENAME_SUFFIX = getattr(
    settings, "IMGPROXY_BASE64_FILENAME_SUFFIX", ""
)
IMGPROXY_IMAGEFIELD_PROCESSING_OPTIONS = getattr(
    settings, "IMGPROXY_IMAGEFIELD_PROCESSING_OPTIONS", {"raw": "true"}
)
